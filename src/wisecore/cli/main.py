...
@click.group(
    ...
    lazy_subcommands={
        "app": ("wisecore.cli.app_cmd", "app_cmd", ".app_cmd"),
        "channels": (
            "wisecore.cli.channels_cmd",
            "channels_group",
            ".channels_cmd",
        ),
        "channel": (
        ...
        "daemon": ("wisecore.cli.daemon_cmd", "daemon_group", ".daemon_cmd"),
        "chats": ("wisecore.cli.chats_cmd", "chats_group", ".chats_cmd"),
        "chat": ("wisecore.cli.chats_cmd", "chats_group", ".chats_cmd"),
        "clean": ("wisecore.cli.clean_cmd", "clean_cmd", ".clean_cmd"),
        "cron": ("wisecore.cli.cron_cmd", "cron_group", ".cron_cmd"),
        "env": ("wisecore.cli.env_cmd", "env_group", ".env_cmd"),
        "init": ("wisecore.cli.init_cmd", "init_cmd", ".init_cmd"),
        "models": (
            "wisecore.cli.providers_cmd",
            "models_group",
            ".providers_cmd",
        ),
        "skills": ("wisecore.cli.skills_cmd", "skills_group", ".skills_cmd"),
        "uninstall": (
            "wisecore.cli.uninstall_cmd",
            "uninstall_cmd",
            ".uninstall_cmd",
        ),
        "desktop": ("wisecore.cli.desktop_cmd", "desktop_cmd", ".desktop_cmd"),
        "update": ("wisecore.cli.update_cmd", "update_cmd", ".update_cmd"),
        "shutdown": (
            "wisecore.cli.shutdown_cmd",
            "shutdown_cmd",
            ".shutdown_cmd",
        ),
        "auth": ("wisecore.cli.auth_cmd", "auth_group", ".auth_cmd"),
        "agents": ("wisecore.cli.agents_cmd", "agents_group", ".agents_cmd"),
        "agent": ("wisecore.cli.agents_cmd", "agents_group", ".agents_cmd"),
    },
)
@click.version_option(version=__version__, prog_name="Wisecore")
