...
def detect_system_timezone() -> str:
    ...
    try:
        ...
        logger.debug("System timezone detection failed: %s", e)
        return "UTC"
...
def _probe_python() -> Optional[str]:
    ...
    try:
        ...
        logger.debug("Python timezone probe failed: %s", e)
    return None
...
def _probe_windows_registry() -> Optional[str]:
    ...
    try:
        ...
        logger.debug("Windows registry timezone probe failed: %s", e)
    return None
...
def _probe_timedatectl() -> Optional[str]:
    ...
    try:
        ...
        logger.debug("timedatectl show probe failed: %s", e)
    ...
    try:
        ...
        logger.debug("timedatectl status probe failed: %s", e)
    return None
