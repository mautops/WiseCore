...
if TYPE_CHECKING:
    from wisecore.providers.multimodal_prober import ProbeResult
...
class OpenAIProvider(Provider):
    ...
    async def check_connection(self, timeout: float = 5) -> tuple[bool, str]:
        ...
        try:
            ...
            logger.debug("Unknown exception connecting to OpenAI: %s", e)
            return (
                False,
    ...
    async def check_model_connection(
        ...
        try:
            ...
            logger.debug("Unknown exception connecting to OpenAI model %s: %s", model_id, e)
            return (
                False,
