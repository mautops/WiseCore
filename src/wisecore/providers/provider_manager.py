...
from wisecore.providers.provider import (
    ModelInfo,
    DefaultProvider,
    Provider,
    ProviderInfo,
)
from wisecore.providers.models import ModelSlotConfig
from wisecore.providers.openai_provider import OpenAIProvider
from wisecore.providers.anthropic_provider import AnthropicProvider
from wisecore.providers.gemini_provider import GeminiProvider
from wisecore.providers.ollama_provider import OllamaProvider
from wisecore.constant import SECRET_DIR
from wisecore.local_models import create_local_chat_model
