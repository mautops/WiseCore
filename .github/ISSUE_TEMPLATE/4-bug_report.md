...
[Provide the version of Wisecore you are using, e.g. 0.x.x or git commit hash.]
[Using `wisecore --version` in your command line or checking the version in the console UI can help.]
...
- **Wisecore version:** [e.g. 0.x.x or git commit]
