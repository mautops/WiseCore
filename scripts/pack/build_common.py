...
"""
Create a temporary conda env, install Wisecore from a wheel, run conda-pack.
...
def _pick_wheel(wheel_arg: str | None) -> Path:
    ...
    wheels = sorted(
        (REPO_ROOT / "dist").glob("wisecore-*.whl"),
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Conda-pack Wisecore (temp env).",
    )
    parser.add_argument(
        "--output",
        "-o",
    ...
    try:
        ...
        try:
            ...
            with tempfile.TemporaryDirectory() as tmpdir:
                ...
                # installing wisecore[full] later.
            ...
            print(
                ...
                "installing wisecore[full]"
            )
            needs_llama_compile = True

        # Install wisecore with all dependencies
